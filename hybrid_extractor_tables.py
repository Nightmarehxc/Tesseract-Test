...
def extraer_tabla_ocr_de_recorte(imagen_recorte):
...
def extraer_tablas_ocr_avanzado(pagina_pdf, imagen_pagina):
    ...
    for tabla in tablas_detectadas:
        ...
        tabla_ocr = extraer_tabla_ocr_de_recorte(imagen_recorte)
        if tabla_ocr:
...
with pdfplumber.open(ruta_pdf) as pdf:
    ...
    for i, pagina in enumerate(pdf.pages):
        ...
        texto_ocr, orientacion, imagen_pagina = extraer_ocr_con_orientacion(
            ruta_pdf,
            numero_pagina,
            ruta_poppler
        )
        ...
        tablas_ocr = extraer_tablas_ocr_avanzado(pagina, imagen_pagina)
